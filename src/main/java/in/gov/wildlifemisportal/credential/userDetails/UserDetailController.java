...
import com.forest.wildlife.credential.jwt.JwtHelper;
import com.forest.wildlife.credential.refreshToken.RefreshToken;
import com.forest.wildlife.credential.refreshToken.RefreshTokenService;
import com.forest.wildlife.credential.role.Role_mRepository;
import com.forest.wildlife.credential.security.payload.request.LoginRequest;
import com.forest.wildlife.credential.security.payload.request.TokenRefreshRequest;
import com.forest.wildlife.credential.security.payload.response.JwtResponse;
import com.forest.wildlife.credential.security.payload.response.MessageResponse;
import com.forest.wildlife.credential.security.payload.response.TokenRefreshResponse;
import com.forest.wildlife.credential.service.UserDetailsImpl;
import com.forest.wildlife.exceptionHandling.exception.commonException.TokenRefreshException;
...
public class UserDetailController {
    ...
    @Autowired
    private UserDetailServiceInter userDetailServiceInter;
...
//}
    ...
    public ResponseEntity<?> insertUserDetail(@RequestBody UserDetailDto userDetailDto) throws JsonProcessingException {
