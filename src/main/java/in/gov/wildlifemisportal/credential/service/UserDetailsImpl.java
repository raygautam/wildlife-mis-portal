...
//  }
  ...
  public UserDetailsImpl(Long id, String username, String email, String password, String stateName, String divisionName, String districtName, String rangeName, List<GrantedAuthority> authorities) {
    this.id = id;
    this.username = username;
    this.email = email;
    this.password = password;
  ...
  public static UserDetailsImpl build(UserDetail_t userDetail_t) {
